...
export const Header=()=>{
    return(
        ...
        <nav className='nav border h-1/2 w-2/12 absolute z-50 flex items-center justify-center   '>
            <ul className='flex flex-col w-full space-y-5 border ml-5 border-orange-400 '>
         ...
         <li className='text-2xl trux'><Link to="/apropos">a propos</Link></li>
            </ul>
        </nav>
