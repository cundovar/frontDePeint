...
const FetchOeuvreByCategorie: React.FC<Props> = ({ categorieUrl,title,presentation,text }) => {
  ...
  return (
    <div className="overflow-y-scroll h-full  pb-96">
    <div className=" flex max-sm:w-full max-sm:hidden  w-4/12 h-1/2 absolute left-0 top-0 ">
     ...
     <div className="w-5/12 2xl:w-4/12 lg:h-1/2 absolute max-sm:relative max-sm:justify-end   text_left flex justify-center items-center bottom-0 left-0  lg:p-16 max-sm:w-full" >
     ...
     <div className=" absolute right-0 w-8/12 lg:h-full text_right max-sm:w-full max-sm:relative   lg:overflow-y-scroll">
