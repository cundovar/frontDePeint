...
const Contact = () => {
  ...
  return (
    <div className="  min-h-full z-20 flex max-lg:flex-col max-lg:items-center justify-center   max-md:pb-40  md:ml-28 overflow-hidden max-md:pt-40 max-lg:mb-10 max-lg:overflow-y-scroll max-sm:mt-9   2xl:pr-10">
