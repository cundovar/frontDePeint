...
return(
    <section className="w-11/12 flex lg:h-full absolute  total right-0 ">
        <MovingDivs/>
...
<div className='flex  items-center justify-end text_left max-sm:mt-0   max-lg:mt-20 max-lg:mr-10 max-md:mr-0 max-lg:w-full   '>
